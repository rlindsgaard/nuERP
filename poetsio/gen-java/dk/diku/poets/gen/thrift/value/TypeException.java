...
public class TypeException extends Exception implements org.apache.thrift.TBase<TypeException, TypeException._Fields>, java.io.Serializable, Cloneable {
  ...
  public TypeException setErrorMsg(String errorMsg) {
    this.errorMsg = errorMsg;
    return this;
  }
  ...
  public int compareTo(TypeException other) {
    ...
    TypeException typedOther = (TypeException)other;
