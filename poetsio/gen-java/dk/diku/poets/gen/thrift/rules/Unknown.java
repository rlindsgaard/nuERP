...
public class Unknown implements org.apache.thrift.TBase<Unknown, Unknown._Fields>, java.io.Serializable, Cloneable {
  ...
  static {
    schemes.put(StandardScheme.class, new UnknownStandardSchemeFactory());
    schemes.put(TupleScheme.class, new UnknownTupleSchemeFactory());
  }
  ...
  public Unknown setId(String id) {
    this.id = id;
    return this;
  }
  ...
  public int compareTo(Unknown other) {
    ...
    Unknown typedOther = (Unknown)other;
